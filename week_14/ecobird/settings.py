...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'app', 'templates')], #Join the template folder from the base Directory
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ecobird.wsgi.application'
